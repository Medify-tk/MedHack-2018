...
/* .category{width:100%;max-width:188px;min-width:150px;min-height:200px;margin-top:15px;display:inline-block;padding:20px 0 10px;border:1px solid #eaebee;border-radius:2px;box-sizing:border-box;text-align:center;text-decoration:none;font-size:1.1em;-webkit-transition:all .3s;transition:all .3s;} */
</style>
<noscript>
  				...
  				<div class="container">
  					<div class="header-wrap">
  						<div class="header-top d-flex justify-content-between align-items-center">
  							<div class="logo">
  								<a href="index.php"><img width="120px" src="images/components/ag-landing/logo.png" alt=""></a>
  							</div>
    ...
    <div class="col-12 col-md-8">
      ...
      <div class="input-group mb-3">
        <div class="input-group-prepend d-inline">
          ...
          <input style="margin-left: 132px" type="text" value="Татьяна Кирбаева" class="form-control" placeholder="Username" aria-label="Username" aria-describedby="basic-addon1">
      </div>
      <div class="input-group mb-3">
        <div class="input-group-prepend d-inline">
          <span class="input-group-text" id="basic-addon1">Номер телефона:</span>
        </div>
          <input style="margin-left: 50px" type="text" value="+7-913-109-26-84" class="form-control" placeholder="Username" aria-label="Username" aria-describedby="basic-addon1">
      </div>
      <div class="input-group mb-3">
        <div class="input-group-prepend d-inline">
          <span class="input-group-text" id="basic-addon1">День рождения::</span>
        </div>
          <input style="margin-left: 57px" type="text" value="14.01.1998" class="form-control" placeholder="Username" aria-label="Username" aria-describedby="basic-addon1">
      </div>
      <div class="input-group mb-3">
        <div class="input-group-prepend d-inline">
          <span class="input-group-text" id="basic-addon1">Email:</span>
        </div>
          <input style="margin-left: 126px" type="text" value="kirbaeva@gmail.com" class="form-control" placeholder="Username" aria-label="Username" aria-describedby="basic-addon1">
      </div>
      <br>
      <ul class="list-group">
  <li class="list-group-item d-flex justify-content-between align-items-center" style="font-size: 25px">
    Количество бонусов
    <span class="badge badge-primary badge-pill" style="font-size: 25px">250</span>
  </li>
</ul><br>
  <center><div class="row" style="margin-left: 30px">
          <div class="category card" style="width: 13rem; margin-left: 10px; margin-top: 10px">
              <a href="mammoplastika/"> <img src="http://sohoclinic.ru/assets/cache_image/menuz/mammoplastika_100x100_5ee.jpg" alt="Маммопластика" title="Маммопластика" height="94" width="94" style="margin-top: 10px">
                  <br> <span class="name">Маммопластика</span> </a>
             <span class="price">от 150 000 руб.</span> </div>
          <div class="category card" style="width: 13rem; margin-left: 10px; margin-top: 10px">
              <a href="liposakciya/"> <img src="http://sohoclinic.ru/assets/cache_image/menuz/liposakciya_100x100_5ee.jpg" alt="Липосакция" title="Липосакция" height="94" width="94" style="margin-top: 10px">
                  <br> <span class="name">Липосакция</span> </a>
             <span class="price">от 125 000 руб. </span> </div>
          <div class="category card" style="width: 13rem; margin-left: 10px; margin-top: 10px">
              <a href="abdominoplastika"> <img src="http://sohoclinic.ru/assets/cache_image/menuz/posle_rodov_100x100_5ee.jpg" alt="Абдоминопластика" title="Абдоминопластика" height="94" width="94" style="margin-top: 10px">
                  <br> <span class="name">Абдоминопластика</span> </a>
             <span class="price">от 120 000 руб.</span> </div>
          <div class="category card" style="width: 13rem; margin-left: 10px; margin-top: 10px">
              <a href="otoplastika"> <img src="http://sohoclinic.ru/assets/cache_image/menuz/ottoplastika_100x100_5ee.jpg" alt="Отопластика" title="Отопластика" height="94" width="94" style="margin-top: 10px">
                  <br> <span class="name">Отопластика</span> </a>
             <span class="price">от 47 000 руб.</span> </div>
          <div class="category card" style="width: 13rem; margin-left: 10px; margin-top: 10px">
              <a href="blefaroplastika/"> <img src="http://sohoclinic.ru/assets/cache_image/assets/.thumbs/images/articles/blefaroplastika-min_100x100_5ee.jpg" alt="Блефаропластика" title="Блефаропластика" height="94" width="94" style="margin-top: 10px">
                  <br> <span class="name">Блефаропластика</span> </a>
             <span class="price">от 80 000 руб.</span> </div>
          <div class="category card" style="width: 13rem; margin-left: 10px; margin-top: 10px">
              <a href="plastika-lica/"> <img src="http://sohoclinic.ru/assets/cache_image/menuz/plastika_litca_100x100_5ee.jpg" alt="Пластика лица" title="Пластика лица" height="94" width="94" style="margin-top: 10px">
                  <br> <span class="name">Пластика лица</span> </a>
             <span class="price">от 10 000 руб.</span> </div>
          <div class="category card" style="width: 13rem; margin-left: 10px; margin-top: 10px">
              <a href="rinoplastika"> <img src="http://sohoclinic.ru/assets/cache_image/menuz/rinoplastika_100x100_5ee.jpg" alt="Ринопластика" title="Ринопластика" height="94" width="94" style="margin-top: 10px">
                  <br> <span class="name">Ринопластика</span> </a>
             <span class="price">185 000 руб.</span> </div>
          <div class="category card" style="width: 13rem; margin-left: 10px; margin-top: 10px">
              <a href="hejloplastika"> <img src="http://sohoclinic.ru/assets/cache_image/menuz/heyloplastika_100x100_5ee.jpg" alt="Хейлопластика" title="Хейлопластика" height="94" width="94" style="margin-top: 10px">
                  <br> <span class="name">Хейлопластика</span> </a>
             <span class="price">от 20 000 руб.</span> </div>
          <div class="category card" style="width: 13rem; margin-left: 10px; margin-top: 10px">
              <a href="plastika-yagodic"> <img src="http://sohoclinic.ru/assets/cache_image/menuz/plastika_yagoditc_100x100_5ee.jpg" alt="Пластика ягодиц" title="Пластика ягодиц" height="94" width="94" style="margin-top: 10px">
                  <br> <span class="name">Пластика ягодиц</span> </a>
             <span class="price">от 71 000 руб.</span> </div>
          <div class="category card" style="width: 13rem; margin-left: 10px; margin-top: 10px">
              <a href="lipofiling"> <img src="http://sohoclinic.ru/assets/cache_image/menuz/lipofiling_100x100_65e.png" alt="Липофилинг" title="Липофилинг" height="94" width="94" style="margin-top: 10px">
                  <br> <span class="name">Липофилинг</span> </a>
             <span class="price">от 54 000 руб.</span> </div>
          <div class="category card" style="width: 13rem; margin-left: 10px; margin-top: 10px">
              <a href="intimnaya-plastika/"> <img src="http://sohoclinic.ru/assets/cache_image/menuz/intimnaya_plastika_100x100_5ee.jpg" alt="Интимная пластика" title="Интимная пластика" height="94" width="94" style="margin-top: 10px">
                  <br> <span class="name">Интимная пластика</span> </a>
             <span class="price">от 30 000 руб.</span> </div>
          <div class="category card" style="width: 13rem; margin-left: 10px; margin-top: 10px">
              <a href="kruroplastika"> <img src="http://sohoclinic.ru/assets/cache_image/menuz/bedra_li_100x100_5ee.jpg" alt="Круропластика" title="Круропластика" height="94" width="94" style="margin-top: 10px">
                  <br> <span class="name">Круропластика</span> </a>
             <span class="price">от 95 000 руб.</span> </div>
  </div>
</div></center>
    <div class="col-6 col-md-4">
      ...
      <div class="card" style="width: 18rem;">
        <div class="card-body">
          ...
          <div class="input-group mb-3">
              <input type="text" class="form-control" placeholder="Введите промокод" aria-label="Username" aria-describedby="basic-addon1">
          </div>
      ...
      <div class="card" style="width: 18rem;">
        <div class="card-body">
          ...
          <div>
            <img class="d-inline" src="https://img.clipartxtras.com/f489acfc460b6fdb9e8b0b41a2b2c3e3_hand-and-pen-clip-art-at-clkercom-vector-clip-art-online-writing-hand-clipart-png_297-249.png" width="50px">
            <p class="d-inline">Написал первую статью</p>
          </div><br>
          <div>
            <img class="d-inline" src="http://pngimg.com/uploads/like/like_PNG13.png" width="50px">
            <p class="d-inline">Оценил 10 новостей</p>
          </div><br>
          <div>
            <img class="d-inline" src="https://png.icons8.com/material/1600/survey.png" width="50px">
            <p class="d-inline">Участвовал в 5 опросах</p>
          </div>
        </div>
      </div><br>
      <div class="card" style="width: 18rem">
        <div class="card-body">
        <div class="js-profile__statistics ag-profile-aside__item ag-profile-side-block">
            <h3 class="ag-profile-side-block__title">Статистика</h3>
<div class="ag-profile-side-block__container">
			<div class="ag-profile-stat">
			<div class="ag-profile-stat__title d-inline">Заполненность профиля...</div>
						<div class="ag-profile-stat__value d-inline">90%</div>
		</div>
			<div class="ag-profile-stat">
			<div class="ag-profile-stat__title d-inline">Пройдено голосований...</div>
						<div class="ag-profile-stat__value d-inline">12</div>
		</div>
			<div class="ag-profile-stat">
			<div class="ag-profile-stat__title d-inline">Оценено новинок...</div>
						<div class="ag-profile-stat__value d-inline">15</div>
		</div>
			<div class="ag-profile-stat">
			<div class="ag-profile-stat__title d-inline">Посещено мероприятий...</div>
						<div class="ag-profile-stat__value d-inline">2</div>
		</div>
			<div class="ag-profile-stat">
			<div class="ag-profile-stat__title d-inline">Приглашено друзей...</div>
						<div class="ag-profile-stat__value d-inline">3</div>
		</div>
			<div class="ag-profile-stat">
			<div class="ag-profile-stat__title d-inline">Активность в социальных сетях...</div>
						<div class="ag-profile-stat__value d-inline">8</div>
		</div>
			<div class="ag-profile-stat">
			<div class="ag-profile-stat__title d-inline">Получено баллов...</div>
						<div class="ag-profile-stat__value d-inline">400</div>
		</div>
			<div class="ag-profile-stat">
			<div class="ag-profile-stat__title d-inline">Потрачено баллов...</div>
						<div class="ag-profile-stat__value d-inline">150</div>
		</div>
	</div>        </div>
      </div>
    </div><br>
    <div class="card" style="width: 18rem;">
      <div class="card-body">
        <h3 class="card-title">Компании партнеры</h3>
        <p>В этих кампаниях партнерах вы можете потратить бонусы до 100%<br><b style="color: black">1 бонус = 1 рубль</b></p>
        <a target="_blank" href="https://letyshops.com/shops" class="btn btn-primary">Посмотреть</a>
      </div>
    </div><br>
    </div>
  </div>
</div>
<footer class="footerNoActive" style="background: -webkit-linear-gradient(0deg, #52fdd9 0%, #2380ff 100%); bottom: 0; margin-top: 20px; position: relative; width: 100%;">
